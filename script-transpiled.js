...
// Create some data, so to create some object
// Creating an array which contains all of the three parks


var allParks = [new Park('Green Park', 1987, 0.2, 215), new Park('National Park', 1994, 2.9, 3541), new Park('Oak Park', 1943, 0.4, 949)];
